...
class Reflector extends Mesh {
	...
	constructor( geometry, options = {} ) {
		...
		const material = new ShaderMaterial( {
			...
			uniforms: UniformsUtils.merge( [ {opacity: {value: 1}}, shader.uniforms ] ),
...
Reflector.ReflectorShader = {
	...
	fragmentShader: /* glsl */`
		...
		void main() {
			...
			vec2 unproj2D = vec2 (vUv.s / vUv.q, vUv.t / vUv.q);
			...
			gl_FragColor = vec4( blendOverlay( sum.rgb, color ), opacity );
